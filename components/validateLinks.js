...
const validateLinks = (link) => {
    ...
    }, (reject) => { return {href: link.href, text: link.text, path: link.file, StatusOfRequest: reject.toJSON().code, StatusText: reject.toJSON().message.substring(0, 22), Code:reject.toJSON().code}})
 return object
}
